...
STAGES: list[tuple[str, str]] = [
    ...
    ("m3", "s2f.m3_fold"),
    ("m6", "s2f.m6_report"),
    # Last, and deliberately after m6: it reads the whole run directory, including what
    # the other stages just wrote into their own manifests.
    ("full", "s2f.full_report"),
]
